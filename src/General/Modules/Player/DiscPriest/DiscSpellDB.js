...
export const baseTalents = {
    // Disc spec tree
    // Tier 1
    lightsPromise: {points: 1, maxPoints: 1, icon: "spell_priest_power-word", id: 322115, select: false, tier: 1},
    ...
    powerWordBarrier: {points: 1, maxPoints: 1, icon: "spell_holy_powerwordbarrier", id: 62618, select: false, tier: 1},
    ...
    revelInPurity: {points: 1, maxPoints: 1, icon: "spell_fire_felflamering_red", id: 373003, select: true, tier: 2},
    ...
    expiation: {points: 2, maxPoints: 2, icon: "spell_shadow_shadowpower", id: 390832, select: true, tier: 3},
    ...
    // Priest class tree
    improvedFlashHeal: {points: 1, maxPoints: 1, icon: "spell_holy_heal", id: 393870, select: true, tier: 4},
    ...
    unwaveringWill: {points: 2, maxPoints: 2, icon: "ability_warrior_unrelentingassault", id: 373456, select: false, tier: 4},
    ...
    //manipulation:
    mindgames: {points: 0, maxPoints: 1, icon: "ability_revendreth_priest", id: 323673, select: false, tier: 4},
